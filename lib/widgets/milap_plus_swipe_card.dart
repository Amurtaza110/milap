...
class MilapPlusSwipeCard extends StatefulWidget {
  ...
  @override
  State<MilapPlusSwipeCard> createState() => _MilapPlusSwipeCardState();
}

class _MilapPlusSwipeCardState extends State<MilapPlusSwipeCard> {
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: AppColors.milapPlusPrimary),
              ),
              child: const Center(
      ...
      child: AnimatedContainer(
        ...
        child: Opacity(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(45),
              border: Border.all(color: AppColors.milapPlusPrimary, width: 1.5),
              boxShadow: [
                BoxShadow(
                ...
                children: [
                  ...
                  if (widget.hasStatus)
                    Container(
                      decoration: BoxDecoration(
                        border: Border.all(
                            color: AppColors.milapPlusPrimary, width: 3),
                        borderRadius: BorderRadius.circular(45),
                      ),
                    ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: AppColors.milapPlusSurface,
          shape: BoxShape.circle,
          border: Border.all(color: AppColors.milapPlusPrimary.withOpacity(0.5)),
          boxShadow: [
            BoxShadow(
        ...
        child: Center(
          child: Icon(icon, color: AppColors.milapPlusPrimary, size: 20),
        ),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        height: 40,
        decoration: BoxDecoration(
          color: AppColors.milapPlusSecondary.withOpacity(0.8),
          shape: BoxShape.circle,
          border: Border.all(color: AppColors.milapPlusPrimary.withOpacity(0.5)),
        ),
        child: Center(
